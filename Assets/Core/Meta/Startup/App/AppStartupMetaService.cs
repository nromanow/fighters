...
namespace Core.Meta.Startup.App {
	public class AppStartupMetaService : IAppStartupMetaService, IDisposable {
		private const string PLAYER_PREFS_CAN_START_APP_KEY = "can_start_app";
		private const string URL_FIELD_KEY = "url";

		private readonly IAppStartupMetaServiceApi _api;
		...
		public AppStartupMetaService (
			IAppStartupMetaServiceApi api,
